...
export default function CheckInClient({ punchinData, currentaddress }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* {punchinData?.firstInTime != undefined || punchinData?.firstInTime != null ? */}
      {/* // <TimerComponent key={convertTimeToUTC(punchinData?.firstInTime)} running={true} initialTime={convertTimeToUTC(punchinData?.firstInTime)} /> : null} */}
