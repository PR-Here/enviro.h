...
export const styles = StyleSheet.create({
    ...
    closeButtonTouchStyle: { position: 'absolute', right: wp(2), top: hp(2), borderRadius: 100, padding: 3 },
    ...
    titleTextStyle: {
        ...
        fontSize: FontSize(40), marginHorizontal: wp(3),
    ...
    attachmentStyle: {
        flexDirection: 'row', alignItems: 'center', marginVertical: hp(2.5), marginHorizontal: wp(3),
    },
